...
/**
 * Texture sample generated by VSTMedia player.
 */
class FVSTMediaTextureSample
...
public:
	...
	/** Virtual destructor. */
	virtual ~FVSTMediaTextureSample()
	{
		FreeBuffer();
	}
...
class FVSTMediaTextureSamplePool : public TMediaObjectPool<FVSTMediaTextureSample> { };
